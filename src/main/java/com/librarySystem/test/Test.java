...
public class Test {
    ...
    public void createUsers() {
        try {
            ...
            // create both
            pDao.add(new Person("abd el salam", "789",
    ...
    public void createBooks() {
        try {
            ...
            Book b1 = new Book("book 1", "123-456", null, null,
                    Book.BORROW_DURATION__7);
    ...
    public void createMembers() {
        try {
            ...
            Member m1 = new Member("member 1", "L1", "2354",
                    new Address("st1", "c1", "s1", "123"), null, null);
            m1.setCheckoutRecord(
                    new CheckoutRecord(0, m1, new ArrayList<CheckoutEntry>()));
    ...
    public void testLogin() throws LibrarySystemException {
        CredentialController c = ControllerFactory
                .getController(Controller.Credential);
    ...
    public void testCheckoutBook() throws LibrarySystemException {
        ...
        System.out.println(b.checkoutBook(8, "123-456"));
    }
    ...
    public void testHibernate() {
        try {
            ...
            // System.out.println("=========================> " +
            // bookDao.add(book).getId());
            //
            // bookDao.getAll(Book.class).forEach((b) ->
            // System.out.println(b.getId() + ": " + b.getTitle()));

            System.out.println("=========================> "
                    + bookDao.getByIndex(1).getTitle());
            ...
            //
            // System.out.println("=========================> " +
            // personDao.add(p).getId());
            //
            // System.out.println("=========================> " +
            // personDao.login(userName, password).getUserName());
